...
class SmoothZDescent(py_trees.behaviour.Behaviour):
    def __init__(self, source_key, z_offset=-0.05, num_steps=40, step_hz=20.0, persistent = False, axis="z", threshold=3.0):
        ...
        self.pub = rospy.Publisher(
            # '/group_rheinrobot/cartesian_impedance_example_controller/equilibrium_pose', # for ROS_NAMESPACE
            '/cartesian_impedance_example_controller/equilibrium_pose',
            PoseStamped, queue_size=10
        )
        self.step_idx = 0
        ...
        self.baseline_force = None
        self.sub = rospy.Subscriber(
            # "/group_rheinrobot/franka_state_controller/franka_states", # for ROS_NAMESPACE
            "/franka_state_controller/franka_states",
            FrankaState, self._state_cb
        )
