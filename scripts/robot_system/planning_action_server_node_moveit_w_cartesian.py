...
class PlanningActionServer:
   ...
   def __init__(self):
       ...
       planner_id = rospy.get_param('~planner_id', 'KPIECE')
    #    planner_id = rospy.get_param('~planner_id', 'RRTConnect')
       ...
       rospy.loginfo(f"  Max Velocity: {self.max_velocity}")
       rospy.loginfo(f"  Max Acceleration: {self.max_acceleration}")
       rospy.loginfo(f"â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    ...
    #            trajectory = tuple
     #       else:
                ...
                plan = self.move_group.retime_trajectory(
                    current_state, 
                    plan, 
                    velocity_scaling_factor=self.max_velocity,
                    acceleration_scaling_factor=self.max_acceleration
                )
                success = True
                trajectory = plan
